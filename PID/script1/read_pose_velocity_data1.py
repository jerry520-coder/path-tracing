...
############################################# 6. virtual_point ##################################################
# 小车跟踪的虚拟点
file6 = "/orbbec/virtual_point.txt"
...
yaw_diff = interpolate_and_difference(
    data2[:, [0, 3]], data1[:, [0, 3]]  # desired_yaw 、actual_yaw
)
